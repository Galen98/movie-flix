<template>
    <div class="col" v-for="(datas) in data" :key="datas.id"> 
        <div class="movie-item">
            <router-link :to="{name:'tv', params:{id:datas.id}}">
              ...
              <div class="movie-item-content text-white">
                  <div class="movie-item-title">
                    ...
                    <div class="movie-infos">
                       ...
                       {{datas.vote_average}} ({{datas.vote_count}})</span>
                       </div>
                       <div class="movie-info">
                       <span v-if="datas.vote_average > 8 && datas.vote_count > 1000">
                        ...
                        <LoveButtonTv :tvData="datas"/>
                        </div>
                        </div>  
                        </template>
    
    <script>
    import LoveButtonTv from './LoveButtonTv.vue';

    export default{
        components:{LoveButtonTv},
        props:{
        data:{
          type:Array,
          default: () => ([]),
