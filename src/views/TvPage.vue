...
export default{
    ...
    axios.get(`https://api.themoviedb.org/3/tv/${this.$route.params.id}?language=en-US`, options)
      .then(response => {
...
<div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1;"></div>
  <div class=" mt-0 text-light text-center" style="position: relative; z-index: 2;">
    <h1 class="display-5 fw-bold text-danger">{{movie.name}}</h1>
...
<li><strong>Last episode:</strong> {{movie.last_air_date}}</li>
<li><strong>Number of episodes:</strong> {{movie.number_of_episodes}} Episodes</li>
<li><strong>Number of seasons:</strong> {{movie.number_of_seasons}} Seasons</li>
